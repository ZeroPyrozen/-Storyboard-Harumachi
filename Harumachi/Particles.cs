    ...
    public class Particles : StoryboardObjectGenerator
    {
        ...
        public override void Generate()
        {
            ...
            for (var i = 0; i < ParticleCount; i++)
            {
                ...
                particle.ScaleVec(OsbEasing.InOutQuad, 0, loopDuration, particle.ScaleAt(startTime), new Vector2(particle.ScaleAt(startTime).X, invertPosition(particle.ScaleAt(startTime)).Y));
                particle.Rotate(OsbEasing.None, 0, loopDuration, particle.RotationAt(startTime), Math.Cos(MathHelper.RadiansToDegrees(particle.RotationAt(startTime))));
        ...
        Vector2 invertPosition(Vector2 pos)
        {
